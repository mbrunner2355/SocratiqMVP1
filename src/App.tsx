...
// Simple EMME Engage Dashboard Component
function EMMEEngageDashboard() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen">
        <Switch>
          <Route path="/" component={EMMEEngageDashboard} />
          <Route path="/emme-engage/*" component={EMMEEngageDashboard} />
        </Switch>
      </div>
    </QueryClientProvider>
  )
