          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex space-x-4">
              <button 
                ...
                className={`px-4 py-2 rounded-md ${activeView === 'home' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Home
              </button>
              <button 
                onClick={() => setActiveView('projects')}
                className={`px-4 py-2 rounded-md ${activeView === 'projects' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Projects
              </button>
              <button 
                onClick={() => setActiveView('intelligence')}
                className={`px-4 py-2 rounded-md ${activeView === 'intelligence' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Intelligence
              </button>
            </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap"><span className="inline-flex px-2 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full">Active</span></td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap"><span className="inline-flex px-2 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded-full">In Review</span></td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap"><span className="inline-flex px-2 py-1 text-xs font-semibold bg-yellow-100 text-yellow-800 rounded-full">Planning</span></td>
